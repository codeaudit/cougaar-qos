...
/**
 * A sample ResourceContext which looks for ip-flow capacity data on any
...
public class SiteFlowDS extends ResourceContext 
{
    ...
    private SiteFlowDS(String[] parameters, ResourceContext parent) 
	throws ParameterError
    {
	...
	protected void initialize(ResourceContext context) {
	    ...
	    String key = "Site" + KEY_SEPR + "Flow" + KEY_SEPR +
		source + KEY_SEPR + 
	    ...
	    String rkey = "Site" + KEY_SEPR + "Flow" + KEY_SEPR +
		destination + KEY_SEPR + 
		source + KEY_SEPR + 
		formulaKey;
	    String[] rparameters = { rkey };
	    ResourceContext rdependency = 
		RSS.instance().resolveSpec("Integrater", rparameters);

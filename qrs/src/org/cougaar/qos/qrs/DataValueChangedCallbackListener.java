...
/**
 * This interface is for objects which want to be notified when the
 * cached value of a DataFormula has changed.  A DataSC instance is
 * such an object, as are any DataFormulas which depend on other
 * formulas. */

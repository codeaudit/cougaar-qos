...
/**
 * A context that deflects symbol lookups to some other context before
 * it walks up the tree.  The deflector is set via setDeflector. */
abstract public class DeflectingContext extends ResourceContext
{
    private ResourceContext deflector;

    protected DeflectingContext(String[] parameters, ResourceContext parent)

    ...
    implements Constants
{
    ...
    private AlarmDS(String[] parameters, ResourceContext parent) 
	throws ParameterError
    {
	...
	private void updateCache() {
	    setCachedValue(new DataValue(System.currentTimeMillis(),
					 CONFIRMED_MEAS_CREDIBILITY));
	...
	protected void initialize(ResourceContext context) {
		...
		if (task != null) RSSUtils.unschedule(task);

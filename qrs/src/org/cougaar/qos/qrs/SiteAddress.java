...
public class SiteAddress
{
    ...
    public static byte[] stringToAddress (String addressString) 
	...
	try {
	    ...
	    return
		unsignedByteToLong(net_bytes[0]) << 24 |
		unsignedByteToLong(net_bytes[1]) << 16 |
		unsignedByteToLong(net_bytes[2]) << 8 |
		unsignedByteToLong(net_bytes[3 ]);
	...
	return 
	    ((net & ((long) 0xff000000)) >> 24) + "." +
	    ((net & ((long) 0x00ff0000)) >> 16) + "." +
	    ((net & ((long) 0x0000ff00)) >> 8) + "." +
	    (net & ((long) 0x000000ff)) +  "/" +
	    maskToCount(mask);
    }
}

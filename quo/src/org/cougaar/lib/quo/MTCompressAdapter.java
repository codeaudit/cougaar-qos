...
{
  private org.cougaar.lib.mquo.CompressQosketImpl qosket;

  // Constructor for BQAdapter
  public MTCompressAdapter() 
  {
     this.qosket  = new org.cougaar.lib.mquo.CompressQosketImpl();
     set_qosket (qosket);
  }
  ...
  throws java.rmi.RemoteException 
  {
     set_contract_Compress( qosket.initContract ("Compress", kernel) );
  }

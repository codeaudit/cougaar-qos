/* -*- JAVA -*- $Id: MTCompressDelegate_client.java,v 1.1 2001-10-18 21:27:35 psharma Exp $ */
...
public class MTCompressDelegate_client implements org.cougaar.core.mts.MT {
  ...
  public void rerouteMessage(org.cougaar.core.society.Message m) throws RemoteException {
    ...
    try { 
    quo_currentRegions = quo_Compress.signalAndEvalAndGetCurrentRegion(quo_sig1);
     } catch (java.rmi.RemoteException pre_meth_ceval_ex) {} 
      // Adaptive code for inplaceof methodcall
      switch (quo_currentRegions[0]) {
      ...
      try { 
quo_currentRegions = quo_Compress.signalAndEvalAndGetCurrentRegion(quo_sig2);

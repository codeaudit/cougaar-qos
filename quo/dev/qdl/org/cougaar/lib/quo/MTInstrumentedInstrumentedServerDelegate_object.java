/* -*- JAVA -*- $Id: MTInstrumentedInstrumentedServerDelegate_object.java,v 1.1 2001-10-18 21:27:36 psharma Exp $ */
...
class MTInstrumentedInstrumentedServerDelegate_object extends java.rmi.server.UnicastRemoteObject  implements org.cougaar.lib.quo.MTInstrumented {
  ...
  protected org.cougaar.lib.quo.MTInstrumented quo_remoteObj;
  void set_remoteObj(org.cougaar.lib.quo.MTInstrumented arg1){
    quo_remoteObj = arg1;
  }
  org.cougaar.lib.quo.MTInstrumented get_remoteObj(){
  ...
  public com.bbn.quo.instr.corba.Trace_rec rerouteMessage(com.bbn.quo.instr.corba.Trace_rec record, org.cougaar.core.society.Message m) throws RemoteException   {
    ...
    quo_currentRegions = quo_InstrumentedServer.signalAndEvalAndGetCurrentRegion(quo_sig1);
    ...
    quo_sig2 = 	new com.bbn.quo.corba.SignalEvent("postmethod", sig);
      quo_currentRegions = quo_InstrumentedServer.signalAndEvalAndGetCurrentRegion(quo_sig2);
  ...
  public com.bbn.quo.instr.corba.Trace_rec receiveCompressedMessage(com.bbn.quo.instr.corba.Trace_rec record, org.cougaar.lib.quo.Zippy compressedMessage) throws RemoteException   {
    // Default declarations and setup of quo introduced variables local to method:
    int[] quo_currentRegions;
    com.bbn.quo.corba.Association [] sig;
    int length;
  ...
  public void receiveOnlyCompressedMessage(org.cougaar.lib.quo.Zippy compressedMessage) throws RemoteException   {
    // Default declarations and setup of quo introduced variables local to method:
    int[] quo_currentRegions;
    com.bbn.quo.corba.Association[] sig =
        new com.bbn.quo.corba.Association[0];
  ...
  public void ignoreCompressedMessage(org.cougaar.lib.quo.Zippy compressedMessage) throws RemoteException   {
    // Default declarations and setup of quo introduced variables local to method:
    int[] quo_currentRegions;
    com.bbn.quo.corba.Association[] sig =
        new com.bbn.quo.corba.Association[0];

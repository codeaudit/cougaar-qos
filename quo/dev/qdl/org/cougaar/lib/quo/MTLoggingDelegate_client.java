/* -*- JAVA -*- $Id: MTLoggingDelegate_client.java,v 1.1 2001-10-18 21:27:36 psharma Exp $ */
...
public class MTLoggingDelegate_client implements org.cougaar.core.mts.MT {
  ...
  public void rerouteMessage(org.cougaar.core.society.Message m) throws RemoteException {
    ...
    try { 
    quo_currentRegions = quo_Logging.signalAndEvalAndGetCurrentRegion(quo_sig1);
      ...
      try { 
quo_currentRegions = quo_Logging.signalAndEvalAndGetCurrentRegion(quo_sig2);

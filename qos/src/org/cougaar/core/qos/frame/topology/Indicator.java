...
public class Indicator
    ...
    public Metric getHeardFrom() {
       ...
       if (!(__raw_container instanceof Agent))
            throw new RuntimeException("Bogus container!");
       Agent __container = (Agent) __raw_container;
       return __container.getHeardFrom();
    }
    ...
    Object getHeardFrom__AsObject() {
       ...
       Agent __container = (Agent) __raw_container;
       return __container.getHeardFrom__AsObject();
    }
    ...
    protected void fireContainerChanges(DataFrame __raw_old, DataFrame __raw_new) {
        ...
        __old = __old_frame.getHeardFrom__AsObject();
        __new = __new_frame.getHeardFrom__AsObject();
        if (__new != null) {
            if (__old == null || !__old.equals(__new)) {
                fireChange("heardFrom", __old, __new);
            }
        }
    ...
    protected void fireContainerChanges(DataFrame __raw) {
        ...
        __new = __new_frame.getHeardFrom__AsObject();
        if (__new != null) {
            fireChange("heardFrom", null, __new);
        }
        __new = __new_frame.getLoadAverage__AsObject();
        if (__new != null) {
    ...
    public SlotDescription slotMetaData__HeardFrom() {
        ...
        __desc.prototype = "agent";
        __desc.value = getHeardFrom__AsObject();
        __desc.is_overridden = false;
        __desc.is_writable = false;
        return __desc;
    }

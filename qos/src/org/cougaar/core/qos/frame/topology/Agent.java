...
public class Agent
   ...
   static {
    ...
    private transient Metric heardFrom;
   ...
   protected void collectSlotValues(java.util.Properties __props) {
        ...
        __value = getHeardFrom__AsObject();
        __props.put("heardFrom", __value != null ? __value : NIL);
   ...
   protected void collectContainerSlotValues(java.util.Properties __props) {
    ...
    public Metric getHeardFrom() {
        return heardFrom;
    }


    Metric getHeardFrom__NoWarn() {
        return heardFrom;
    }


    Object getHeardFrom__AsObject() {
        return heardFrom;
    }


    protected void initializeHeardFrom(Metric new_value) {
        this.heardFrom = new_value;
        slotInitialized("heardFrom", new_value);
    }


    void initializeHeardFrom__AsObject(Object new_value) {
        this.heardFrom = force_Metric(new_value);
        slotInitialized("heardFrom", new_value);
    }
   ...
   protected Object getLocalValue(String __slot) {
       ...
       else if ("heardFrom" == __key)
            return getHeardFrom__AsObject();
   ...
   protected void initializeLocalValue(String __slot,
       ...
       if ("bytesIn" == __key)
            ...
            initializeHeardFrom__AsObject(__value);
       else if ("cpuLoadMJips" == __key)
   ...
   protected void postInitialize() {
        ...
        __observer = new java.util.Observer() {
            public void update(java.util.Observable __xxx, Object __new) {
                Object __old = heardFrom;
                heardFrom = (Metric) __new;
                slotModified("heardFrom", __old, __new, true, true);
            }
        };
        heardFrom = getFrameSet().getMetricValue(this, "Agent($(name)):LastHeard()");
        getFrameSet().subscribeToMetric(this, __observer, "Agent($(name)):LastHeard()");
        __observer = new java.util.Observer() {
            public void update(java.util.Observable __xxx, Object __new) {
   ...
   protected void collectSlotNames(java.util.Set<String> slots) {
    ...
    public SlotDescription slotMetaData__HeardFrom() {
        SlotDescription __desc = new SlotDescription();
        __desc.name = "heardFrom";
        __desc.prototype = "agent";
        __desc.is_writable = false;
        Object __value;
        __value = heardFrom;
   ...
   protected void collectSlotDescriptions(java.util.Map<String,SlotDescription> map) {
        ...
        map.put("heardFrom", slotMetaData__HeardFrom());

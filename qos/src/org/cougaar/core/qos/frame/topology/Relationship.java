...
public class Relationship
    ...
    private static final String parent_value__SlotVar__ = "parent-value".intern();
    private static final String child_value__SlotVar__ = "child-value".intern();


    protected Object getLocalValue(String __slot) {
       String __key = __slot.intern();
       if (parent_value__SlotVar__ == __key)
            return getParentValue__AsObject();
       else if (child_value__SlotVar__ == __key)

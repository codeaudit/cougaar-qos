...
public class CpuIndicator
    ...
    private static final String calmThreshold__SlotVar__ = "calmThreshold".intern();
    private static final String idleThreshold__SlotVar__ = "idleThreshold".intern();
    private static final String watchSlot__SlotVar__ = "watchSlot".intern();
    private static final String normalThreshold__SlotVar__ = "normalThreshold".intern();
    private static final String franticThreshold__SlotVar__ = "franticThreshold".intern();
    private static final String busyThreshold__SlotVar__ = "busyThreshold".intern();


    protected Object getLocalValue(String __slot) {
       String __key = __slot.intern();
       if (calmThreshold__SlotVar__ == __key)
            return getCalmThreshold__AsObject();
       else if (idleThreshold__SlotVar__ == __key)
            return getIdleThreshold__AsObject();
       else if (watchSlot__SlotVar__ == __key)
            return getWatchSlot__AsObject();
       else if (normalThreshold__SlotVar__ == __key)
            return getNormalThreshold__AsObject();
       else if (franticThreshold__SlotVar__ == __key)
            return getFranticThreshold__AsObject();
       else if (busyThreshold__SlotVar__ == __key)

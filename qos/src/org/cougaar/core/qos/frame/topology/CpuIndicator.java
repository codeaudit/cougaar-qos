    ...
    extends Indicator
{
        ...
        org.cougaar.core.qos.frame.FrameMaker __fm = 
            new org.cougaar.core.qos.frame.FrameMaker() {
                public DataFrame makeFrame(FrameSet frameSet, UID uid) {
                     return new CpuIndicator(frameSet, uid);
                }
            };
            DataFrame.registerFrameMaker("org.cougaar.core.qos.frame.topology", "cpuIndicator", __fm);
    }
                        ...
                        UID uid)
    {
        ...
        initializeWatchSlot("cpuLoadAverage");
        initializeNormalThreshold(0.5);
        initializeFranticThreshold(2.0);
        initializeBusyThreshold(1.0);
    }
    ...
    protected Object getLocalValue(String __slot)
    {
       ...
       else if (watchSlot__HashVar__ == __key)

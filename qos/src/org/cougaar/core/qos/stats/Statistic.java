...
public interface Statistic extends Cloneable, Serializable {
     ...
     */
    public Statistic delta(Statistic earlierStatistic);
     ...
     */
    public Statistic clone() throws CloneNotSupportedException;
    
    /*
     * Snapshot the content of the statistics, setting endTime to the current time;
     */
    public Statistic snapshot();
